...
public class TagCommandServiceMock: TagCommandService {
    ...
    public var performHandler: ((@escaping () -> Void) -> ())?
    ...
    public var beginHandler: (() throws -> ())?
    ...
    public var commitHandler: (() throws -> ())?
    ...
    public var cancelHandler: (() throws -> ())?
...
public class CloudKitAvailabilityObservableMock: CloudKitAvailabilityObservable {
    ...
    public var isCloudKitAccountAvaialbe: Bool? = nil { didSet { isCloudKitAccountAvaialbeSetCallCount += 1 } }
}

public class SharedUserSettingStorageMock: SharedUserSettingStorage {
    public init() { }
    public init(markAsReadAtCreate: AnyPublisher<Bool, Never>, markAsReadAtCreateValue: Bool = false) {
        self._markAsReadAtCreate = markAsReadAtCreate
        self.markAsReadAtCreateValue = markAsReadAtCreateValue
    }


    public private(set) var markAsReadAtCreateSetCallCount = 0
    private var _markAsReadAtCreate: AnyPublisher<Bool, Never>!  { didSet { markAsReadAtCreateSetCallCount += 1 } }
    public var markAsReadAtCreate: AnyPublisher<Bool, Never> {
        get { return _markAsReadAtCreate }
        set { _markAsReadAtCreate = newValue }
    }

    public private(set) var markAsReadAtCreateValueSetCallCount = 0
    public var markAsReadAtCreateValue: Bool = false { didSet { markAsReadAtCreateValueSetCallCount += 1 } }

    public private(set) var setCallCount = 0
    public var setHandler: ((Bool) -> ())?
    public func set(markAsReadAtCreate: Bool)  {
        setCallCount += 1
        if let setHandler = setHandler {
            setHandler(markAsReadAtCreate)
        }
...
public class UserSettingStorageMock: UserSettingStorage {
    ...
    public var setMarkAsReadAutomaticallyHandler: ((Bool) -> ())?
...
public class URLLoadableMock: URLLoadable {
    ...
    public var loadHandler: ((@escaping (URL?) -> Void) -> ())?
