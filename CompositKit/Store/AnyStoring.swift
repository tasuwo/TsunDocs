...
private class StoringBoxBase<State: Equatable, Action: CompositKit.Action, Dependency> {
...
public class AnyStoring<State: Equatable, Action: CompositKit.Action, Dependency> {
